...
public class EventTopicController {
    ...
    @GetMapping("/api/admin/event-topics") @RoleRequired
    public Result<List<EventTopic>> list() { return Result.ok(topicService.listAll()); }

    @PostMapping("/api/admin/event-topics") @RoleRequired
    ...
    @PutMapping("/api/admin/event-topics/{id}") @RoleRequired
    ...
    @DeleteMapping("/api/admin/event-topics/{id}") @RoleRequired
